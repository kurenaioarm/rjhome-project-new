...
use RJDataExport\models\LoginForm;
use Yii;
...
class LoginController extends \yii\web\Controller
{
    ...
    {
        $this->layout = '@app/../themes/login-template-1/views/layouts/login_RJDataExport';
...
//                echo '<pre>';
                ...
                if($obj_access_token == null){
                    ...
                    if($obj_access_token->json_result == true ){
                        ...
                        $PROJECT_ID = "004"; //เปลี่ยนตามรหัสโปรเจค
                        //===========================================
...
//                    if($chk_expdate == '2190100' || $chk_expdate == '3070100' ||   $chk_expdate == '2110000'){
                        ...
                        return $this->redirect(['dataexport/ods_index']);
//                    }else{
