...
//use RJDataExport\assets\AppAsset;
use RJDataExport\assets\MintyAsset;
...
<?php $this->beginPage() ?>
    ...
    <header>
        ...
        <?php
            NavBar::begin([
                'brandLabel' => 'RJ DATA EXPORT',
                'brandUrl' => ['/dataexport/ods_index'],
                'options' => [
                    'class' => 'navbar navbar-expand-md navbar-dark bg-dark fixed-top',
                ],
            ]);
            $menuItems = [
                ['label' => 'Home', 'url' => ['/dataexport/ods_index']],
