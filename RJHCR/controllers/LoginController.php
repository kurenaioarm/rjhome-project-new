...
class LoginController extends \yii\web\Controller
{
    ...
    {
        $this->layout = '@app/../themes/login-template-1/views/layouts/login_RJHCR';
...
//                echo '<pre>';
                ...
                if($obj_access_token == null){
                    ...
                    if ($obj_access_token->json_result == true) {
                        ...
                        Yii::$app->session->set('arrayAccess_Token',$currentToken);
                        ...
                        $chk_staff = $payload->staff;
                        Yii::$app->session->set('arrayAccess_Staff',$chk_staff);
                        ...
                        $PROJECT_ID = "003"; //เปลี่ยนตามรหัสโปรเจค
                        //===========================================
//                    if ($chk_expdate == '2190100' || $chk_expdate == '3070100' || $chk_expdate == '2110000') { //ส ิทธิ์การ Login
                        ...
                        //==================================================================
                        return $this->redirect(['healthcheck/index']);
//                    } else {
